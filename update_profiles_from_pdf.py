...
pdf_path = Path(r'c:/Users/Wajeeh/Desktop/Compiler2.0-main/23I_Seating_Extract.pdf')
...
Path('db/23.json').write_text(json.dumps(payload, indent=2, ensure_ascii=False) + '\n', encoding='utf-8')
